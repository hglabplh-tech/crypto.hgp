...
(define cms-check-explore-impl-base%
  (class* impl-base% (cms-check-explore<%>)
    (inherit about get-spec get-factory)
    (super-new)
    (define/public (cms-content/DER->content-info  content-info-buffer) #f)
    (define/public (cms-content/SMIME->content-info content-info-buffer) #f)
    (define/public (cms-sig-verify box-content-info cert-stack-list flags) #f)
    (define/public (cms-decrypt box-content-info cert-bytes pkey-bytes pkey-fmt flags) #f)    
    (define/public (cms-decrypt-with-skey box-content-info skey-bytes flags) #f)
