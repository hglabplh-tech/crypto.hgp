openssl req -new -newkey rsa:2048 -nodes -out ca.csr -set_serial 03 -keyout ca.key
openssl x509 -trustout -signkey ca.key -days 365 -req -set_serial 04 -in ca.csr -out ca.pem
